      ...
      <Dialog open={props.isOpen} as="div" className="relative z-10 focus:outline-none blur-none" onClose={close}>
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              transition
              className={`${props.mainSettings.exisitingDupesFound.length > 0 ? 'w-max ' : 'max-w-md'} flex flex-col w-full rounded-xl border-2 border-[#0B3FB6] bg-[#000C47] p-6 text-[#EDF1FB] font-[family-name:var(--font-geist-sans)] duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0`}
            >
              { props.userSettings.password === '' ?
                ...
                <div className="mt-4 flex flex-row-reverse">
                    <Button
                      className="rounded-md bg-[#0B3FB6] px-3.5 py-2.5 text-3xl font-semibold text-[#EDF1FB] shadow-xs hover:bg-[#002EE8] justify-self-end self-end"
                      onClick={close}
                    >
                      Understood
                    </Button>
                ...
                <DialogTitle as="h1" className="text-4xl justify-self-center self-center" >
                  ...
                  <div className="mt-4 flex justify-center">
                    <Button
                      className="rounded-md bg-[#0B3FB6] px-3.5 py-2.5 text-3xl font-semibold text-[#EDF1FB] shadow-xs hover:bg-[#002EE8]"
                      onClick={close}
                    >
                      Got it, thanks!
                    </Button>
